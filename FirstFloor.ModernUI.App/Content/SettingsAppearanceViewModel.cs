...
namespace FirstFloor.ModernUI.App.Content
{
        ...
        : NotifyPropertyChanged
    {
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            this.themes.Add(new Link { DisplayName = "HSM", Source = new Uri("/ModernUIDemo;component/Assets/ModernUI.Hsm.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "doctor", Source = new Uri("/ModernUIDemo;component/Assets/ModernUI.Doctor.xaml", UriKind.Relative) });
